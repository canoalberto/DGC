...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////warning("flat fitness landscape, consider reformulation of fitness, step-size increased");
    ...
    public double[] LBound, UBound;    // bounds
    double[] xmean;
    ...
    /* fitness information */
    class FitnessCollector implements Serializable {
        double history[];
...
//    }
    ...
    class MyMath implements Serializable { // implements java.io.Serializable {
        int itest;
            ...
            */
        	...
        	if (flgdiag)  
        	    ...
        	    for (i = 0; i < N; ++i) {
        			...
        			double res = xmean[i] + sigma * sum;
        			
        			/*if(res < LBound[i])
        				res = rand.nextDouble() * xmean[i];
        			
        			if(res > UBound[i])
        				res = xmean[i] + rand.nextDouble() * (1.0 - xmean[i]);*/
        			
        			arx[iNk][i] = Math.abs(res);
        		}
            }
	        	
        	//isOutOfBounds(arx[iNk]);
...
//                + (System.currentTimeMillis()-timings.start)  + " " + opts.maxTimeFractionForWriteToDefaultFiles);
    ...
    public class CMAException extends RuntimeException implements Serializable {
...
class IntDouble implements Comparator<IntDouble>, Serializable{
