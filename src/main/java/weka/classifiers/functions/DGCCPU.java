...
import net.sf.jclec.problem.classification.dgc.DGCAlgorithm;
import net.sf.jclec.problem.classification.dgc.DGCEvaluator;
import net.sf.jclec.problem.classification.dgc.DGCEvaluatorAUC;
...
public class DGCCPU extends AbstractClassifier implements OptionHandler, WeightedInstancesHandler, TechnicalInformationHandler
{
	private static final long serialVersionUID = 6639194007580838497L;

	protected DGCAlgorithm algorithm;
	...
	public void configureMetadata(Instances instances) throws Exception
	{
		...
		((DGCEvaluator) algorithm.getEvaluator()).setSpecies((DGCSpecies) algorithm.getSpecies());
	}
